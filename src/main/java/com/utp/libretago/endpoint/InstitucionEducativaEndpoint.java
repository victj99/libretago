...
/**
 * Endpoint para la gestión de Instituciones Educativas.
 * Permite buscar, crear, actualizar, inactivar y listar instituciones educativas.
 * Solo accesible por usuarios con rol {@link RolesEnum#ADMIN}.
 * 
...
/**
     * Busca instituciones educativas aplicando filtros específicos y paginación.
     * <p>Este método permite consultar las instituciones educativas según criterios
     * definidos en {@link FiltroInstitucionEducativa}, retornando los resultados
     * paginados y ordenados por defecto en orden descendente por su ID.</p>
     * @param filtro   Objeto que contiene los criterios de búsqueda como nombre,
     *                 código UGEL u otros parámetros configurables.
...
/**
     ...
     * <p>Este método busca una institución educativa en la base de datos
     * utilizando el servicio {@link institucionEducativaService}. Si la institución
     * existe, devuelve el objeto correspondiente; de lo contrario, retorna {@code null}.</p>
...
/**
     * Inactiva una institución educativa en el sistema.
     * <p>Este método no elimina la institución, sino que la marca como inactiva,
     * evitando que se use en futuras operaciones.</p>
