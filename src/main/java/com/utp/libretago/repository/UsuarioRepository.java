 ...
 * operaciones CRUD, paginación, ordenamiento y consultas dinámicas sobre los usuarios
...
public interface UsuarioRepository extends JpaRepository<Usuario, Long>, JpaSpecificationExecutor<Usuario> {
     ...
     * <p>
     * Este método es utilizado comúnmente durante el proceso de autenticación
     * para recuperar los datos básicos del usuario.
     * </p>
     *
     ...
     * <p>
     * Utiliza un <i>fetch join</i> para evitar el problema de la carga perezosa
     * (LazyInitializationException) al acceder a los roles fuera del contexto de persistencia.
     * </p>
     *
     * @param nombreUsuario nombre único del usuario.
     ...
     * <p>
     * Esta operación no elimina el registro de la base de datos, preservando así
     * su historial y relaciones asociadas.
     * </p>
     *
