 ...
 *
 * Esta clase implementa un registro (record) que encapsula los posibles criterios de búsqueda que se pueden aplicar
 * sobre la entidad Alumno. Permite generar dinámicamente una {@link Specification} que será utilizada por Spring Data
 * JPA para realizar consultas personalizadas en función de los parámetros proporcionados.
 *
 * <b>Uso principal:</b>
 * <ul>
 ...
 * @version 1.0
 * @since 28-10-2025
 * @param nombres      Nombres o parte de los nombres del alumno (búsqueda parcial).
 * @param apellidos    Apellidos o parte de los apellidos del alumno (búsqueda parcial).
 * @param codigoAlumno Código del alumno (búsqueda parcial).
 */
public record FiltroAlumno(String nombres, String apellidos, String codigoAlumno) {
     ...
     *
     * Construye una lista de {@link Predicate} en función de los campos proporcionados en el filtro. Cada campo se evalúa
     * de manera independiente: si el valor no es nulo ni está en blanco, se añade una condición <i>LIKE</i> (con
     * coincidencia parcial, insensible a mayúsculas/minúsculas) al conjunto de predicados.
     *
