 ...
 *
 * Permite construir consultas dinámicas usando el patrón <b>Specification</b> de Spring Data JPA. Solo se aplican los
 * filtros que tengan valores no nulos y, en el caso de cadenas, no estén vacíos.
 *
 *
 * Ejemplo de uso:
 * 
 ...
 * }</pre>
 *
 * En este ejemplo, la consulta buscará instituciones cuyo nombre contenga "Colegio Salesiano Don Bosco", cuyo código
 * UGEL sea "UGEL PIURA" y que estén activas.
 *
