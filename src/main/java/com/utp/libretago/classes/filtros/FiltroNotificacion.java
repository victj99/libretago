 ...
 * <p>
 * Permite construir consultas flexibles utilizando el patrón <b>Specification</b>
 * de Spring Data JPA. Solo se aplican los filtros que tengan valores
 * no nulos y, en el caso de cadenas, no estén en blanco.
 * </p>
 *
 ...
 * }</pre>
 *
 * <p>La consulta buscará notificaciones cuyo título contenga "Reunión" 
 * y cuyo estado sea "PENDIENTE".</p>
 *
