 ...
 * 
 * <p>Provee métodos para registrar, actualizar, validar, buscar y administrar usuarios,
 * así como para interactuar con su información institucional y roles asociados.</p>
 *
 * <p>Esta interfaz define la lógica del dominio de usuarios, mientras que las
 * implementaciones concretas se encargan de interactuar con los repositorios
 * y manejar la lógica de negocio correspondiente.</p>
 * 
...
public interface UsuarioService {
    ...
    /**
     * Valida el contenido de un archivo Excel que contiene datos de usuarios.
     * <p>Este método revisa la estructura y los datos del archivo subido para
     * verificar que cumplan con los criterios esperados antes de importarlos
     * al sistema.</p>
     * @param file el archivo Excel cargado mediante un formulario.
     * @return un objeto {@link ExcelValidadoDTO} que contiene los registros validados y
     *   los errores encontrados durante la validación.
  ...
  /**
    ...
    /**
     * Lista usuarios según su nombre o criterios definidos en los filtros.
     * <p>Este método devuelve una lista optimizada para controles de selección o autocompletado,
     * utilizando el formato {@link LabelValueDTO}.</p>
     ...
     * @return un {@link Optional} que contiene el {@link UsuarioInstitucionDTO} si existe o vacío si no se encuentra el usuario.
     */
    ...
    /**
         * Inactiva un usuario según su identificador.
         * <p>El usuario no se elimina físicamente del sistema, sino que se marca
         * como inactivo para preservar la trazabilidad de los registros.</p>
