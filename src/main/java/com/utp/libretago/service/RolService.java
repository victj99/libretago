 ...
 * 
 * <p>Define las operaciones básicas de mantenimiento (CRUD) 
 * sobre la entidad {@link Rol}, que representa los distintos
 * niveles o permisos de acceso que puede tener un usuario.</p>
 * 
 * <p>Ejemplos de roles pueden ser: <strong>Administrador</strong>,
 * <strong>Profesor</strong>, <strong>Apoderado</strong>, entre otros.</p>
 * 
 * @author Roberto
 * @version 1.0
 * @since 2025-10-28
